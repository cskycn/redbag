...
class NavController extends AdminBaseController
{
    public function index()
    {
        ...
        $serverInfo = array();
        $serverInfo['server_host'] = $_SERVER['HTTP_HOST'];
        $serverInfo['server_port'] = $_SERVER['SERVER_PORT'];
        $serverInfo['server_time'] = date("Y-m-d H:i:s");
        $serverInfo['server_os'] = php_uname('s');
        $serverInfo['server_ip'] = $_SERVER['SERVER_ADDR'];
        $serverInfo['server_name'] = gethostbyaddr($_SERVER[ 'SERVER_ADDR ']); ;
        $serverInfo['server_cpu'] = $sysinfo['cpu']['num'];
        $serverInfo['server_cpu_type'] = $sysinfo['cpu']['num_text'];
        $serverInfo['server_gqtime'] = ini_get('max_execution_time').'秒';
        $serverInfo['server_uptime'] = $sysinfo['uptime'];
